  ...
  methods: {
    ...
    loginJWT: function loginJWT() {
      ...
      this.$store.dispatch('auth/loginJWT', payload).then(function (response) {
        ...
        _this.$acl.change(response.data.user.role); //this.$router.push({ name: 'user', params: { userId: '123' } })
        ...
        _this.showAlert(_i18n_i18n__WEBPACK_IMPORTED_MODULE_0__["default"].t('Error'), _i18n_i18n__WEBPACK_IMPORTED_MODULE_0__["default"].t('you_are_logged_in'), 'icon-alert-circle', 'warning');
      });
    },
