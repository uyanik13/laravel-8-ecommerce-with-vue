						...
						<div class="row">
							...
							<div
								...
								<div class="sort-by-dropdown d-flex align-items-center mb-xs-10 full-width" >
                                        @csrf
                                        <select style="width: 200px" id="filter_product_name" name="filter_product_name" onchange="if (this.selectedIndex) sortByKey(this.selected,`{{csrf_token()}}`);"  class="short-option-field form-control align-items-center">
								...
								<p class="result-show-message">Showing 1–12 of {{count($catProducts)}} results</p>
							</div>
						</div>
					</div>
