...
var _default = {
  addItem: function addItem(_ref, data) {
    ...
    return new Promise(function (resolve, reject) {
      _axios["default"].post("/api/subscription", data).then(function (response) {
  ...
  fetchItems: function fetchItems(_ref2) {
    ...
    return new Promise(function (resolve, reject) {
      _axios["default"].get("/api/subscription").then(function (response) {
  ...
  updateItem: function updateItem(_ref3, data) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      _axios["default"].patch("/api/subscription/".concat(data.id), data).then(function (response) {
  ...
  removeItem: function removeItem(_ref4, itemId) {
    ...
    return new Promise(function (resolve, reject) {
      _axios["default"]["delete"]("/api/subscription/".concat(itemId)).then(function (response) {
