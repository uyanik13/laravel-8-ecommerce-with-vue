...
<template>
  <div id="data-list-thumb-view" class="data-list-container">
    ...
    <product-sidebar :isSidebarActive="addNewDataSidebar" @closeSidebar="toggleDataSidebar" :data="sidebarData" />
      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
        ...
        <div class="flex flex-wrap-reverse items-center data-list-btn-container">
          ...
          <div class="btn-add-new p-3 mb-4 mr-4 rounded-lg cursor-pointer flex items-center justify-center text-lg font-medium text-base text-primary border border-solid border-primary" @click="addNewData">
              ...
              <span class="ml-2 text-base text-primary">{{$t('addProduct')}}</span>
          </div>
        </div>
          ...
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              <vs-td class="img-container">
                <img :src="tr.thumbnail" class="product-img" height="100px" width="100px"/>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.title.substring(0, 25) }}</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.slug.substring(0, 10) }}</p>
              </vs-td>

              <vs-td>
                <vs-chip :color="'primary'" class="product-order-status">{{ tr.price}}</vs-chip>
              </vs-td>
              <vs-td>
                <vs-chip :color="'#328AF1'" class="product-order-status">{{ tr.discounted_price}}</vs-chip>
              </vs-td>
